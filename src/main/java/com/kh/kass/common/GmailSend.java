...
//전역변수 사용안함.
	...
	// action
	public void GmailSet(String receiver, String subject, String content, String fromName) {
		...
		Authenticator auth = new GmailAuthentication(); // 구글 계정 인증
		...
		try {
			...
			from = new InternetAddress(new String(fromName.getBytes(charSet), "8859_1") + "sssamba.zzeong@gmail.com");
			msg.setFrom(from);
