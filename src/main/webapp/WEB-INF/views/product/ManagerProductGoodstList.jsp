								...
								<li class>
									<a href="${ gdetail }" title="스낵" class="product">
										...
										<div class="info">
											...
											<div class="price">
												<p class="original">${ Goods.goodsMemo }원</p>
												<p class="sale">
				...
				<div class="pagination">
					<div class="pageOuterDiv">
						<div class="pageInnerDiv">
							...
							<c:if test="${ pi.currentPage > 1 }">
								<c:url var="before" value="ManagerGoodsList.do">
							...
							<c:forEach var="p" begin="${ pi.startPage }"
								...
								<c:if test="${ p ne pi.currentPage }">
									<c:url var="pagination" value="ManagerGoodsList.do">
							...
							<c:if test="${ pi.currentPage < pi.maxPage }">
								<c:url var="after" value="ManagerGoodsList.do">
									<c:param name="page" value="${ pi.currentPage + 1 }" />
								</c:url>
