				...
				<div id="divNewPrdtArea">
							...
							<table class="proTable">
								<tr>
									<td><label class="label1">카테고리 </label> <select
										name="snCateNo" id="categoryKey" style="width:300px;height:40px;">
											...
											<option value="2"
												<c:if test="${Snack.snCateNo == 2}"> selected</c:if>>음료</option>
											<option value="3"
												<c:if test="${Snack.snCateNo == 3}"> selected</c:if>>콤보</option>
								...
								<tr>
									<td colspan="2"><label class="label2">상품명 </label> <input
										type="text" name="snackName" value="${ Snack.snackName }"
										size="30"></td>
								</tr>
								<tr>
									<td><label class="label3">가격 </label> <input type="number"
										min="0" name="snackPrice" value="${ Snack.snackPrice }"
										size="2"></td>
								</tr>
								<tr>
									<td><label class="label4">상품 설명</label> <textarea
											style="resize: none;" id="memo" min="0" name="snackMemo"
											size="500" rows="10" cols="40">${ Snack.snackMemo }</textarea></td>
								</tr>
							</table>
						</div>
						<div class="right">
					...
					<div class="btn_wrap">
						<button type="button" class="button cancel"
							onclick="location.href='${ ManagerSnackList }'">목록으로</button>
						<button type="submit" class="button insert"
							onclick="location.href='${ supdate }'">수정</button>
					</div>

					<div class="btn_wrap">
						<c:url var="sdelete" value="sdelete.do">
							<c:param name="snackNo" value="${ Snack.snackNo }" />
						</c:url>
						<button type="button" class="button delete"
							onclick="location.href='${ sdelete }'">삭제</button>
					</div>
				</div>
			</form>
