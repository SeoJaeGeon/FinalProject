...
<c:set var="contextPath" value="${ pageContext.servletContext.contextPath }" scope="application"/>
    <link href="${ contextPath }/resources/css/findUserInfo.css" rel="stylesheet" type="text/css">
        ...
        <div class="content">
            ...
            <div class="wrapper">
                <div class="tabs cf">
                    ...
                    <label for="tab1" class="tLabel">아이디 찾기</label>
                    <input type="radio" name="tabs" id="tab2">
                    <label for="tab2" class="tLabel">비밀번호 찾기</label>
                    ...
                    <div id="tab-content1" class="tab-content">
                        <!-- <form id="idFind" name="idFindForm" action="mfindId.do" method="post"> -->
                            ...
                            <table class="simpleTable">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" id="userBirth" class="birth" name="userBirth" placeholder="생년월일 앞 8자리">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" id="userPhone" class="phone" name="userPhone" placeholder="'-' 없이 입력">
                                    </td>
                                </tr>
                            </table>
                            <div class="guide">※ 휴대폰 번호가 변경 된 경우 본인인증 찾기를 통하여 아이디 찾기를 진행해 주시기 바랍니다.</div>
                            <div class="button"><button class="idFindBtn" onclick="return simpleIdFind();">아이디 찾기</button></div>
                        <!-- </form>  -->
                        ...
                        <div>
                            ...
                            <div class="guide2">본인인증 시 제공되는 정보는 해당 인증기관에서 직접 수행하며, 인증 이외의 용도로 이용 또는 저장되지 않습니다.</div>
                            <div class="button"><button class="idFindBtn" function="certification();">본인인증</button></div>
                        </div>
                    </div>
                    ...
                    <div id="tab-content2" class="tab-content">
                        <form id="pwdFindForm" name="pwdFindForm">
                            ...
                            <table class="simpleTable">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" id="userName_2" class="userName" name="userName" placeholder="이름">
                                        <button type="button" onclick="findUserInfo();" class="findUserBtn">찾기</button>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="answer" name="userPwdA" id="answer" placeholder="답변"
                                            disabled>
                                    </td>
                                </tr>
                            </table>
                            <div class="guide">※ 휴대폰 번호가 변경 된 경우 본인인증 찾기를 통하여 비밀번호 찾기를 진행해 주시기 바랍니다.</div>
                            <div class="button"><button class="pwdFindBtn" onclick="return simplePwdFind();">비밀번호 찾기</button></div>
                        </form>
                        ...
                        <div>
                            ...
                            <form>
                                ...
                                <div class="button"><button class="pwdFindBtn" onclick="certification();">본인인증</button></div>
                            </form>
                        </div>
                    </div>
                </div>
