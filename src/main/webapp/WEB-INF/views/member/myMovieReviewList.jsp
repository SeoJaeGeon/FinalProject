...
<head>
	...
	<link href="${ contextPath }/resources/css/member/myMovieReviewList.css" rel="stylesheet" type="text/css">
						...
						<table class="contentTable">
							...
							<c:if test="${ list ne null }">
								<c:forEach var="mrv" items="${ list }">
									<tr>
										<td class="left"><img src="${ contextPath }/resources/images/movie_image/${ mrv.attachment.renameFileName }"
											 class="poster"></td>
										<td class="right">
											<div>
												<div class="movieTitle">${ mrv.movieName }</div>
												<p class="idDate">
													<!-- <span class="userId">us***1</span> |  -->
													<span class="writerDate">${ mrv.reEnrollDate }</span>
												</p>
											...
											<div class="bottomTdDiv">
												...
												<div class="buttons">
													<a href="javascript:openReviewUpdateForm(${ mrv.movieNo },'${ mrv.movieName }', '${ mrv.reContent }', '${ mrv.reScore }');"
													 id="update" class="update">수정</a> <a href="javascript:deleteReview(${ mrv.movieNo },'${ mrv.movieName }');"
