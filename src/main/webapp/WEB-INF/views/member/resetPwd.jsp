...
<body>
    <div class="content">
        ...
        <h2>비밀번호 재설정</h2>
        <form id="pwdResetForm" action="pwdReset.do" method="POST" onsubmit="return pwdReset();" enctype="multipart/form-data">
            <table align="center">
                <tr>
                ...
                <tr>
                    ...
                    <td class="right"><span class="userId">${ userId }</span>
                ...
                <tr>
                    <td colspan="2" class="span2">
                        <ul style="-webkit-padding-start:20px;">
                            ...
                            <li>생년월일, 전화번호 등 개인정보와 관련된 숫자, 연속된 숫자와 같이 쉬운 비밀번호는 다른사람이 쉽게 알아낼 수 잇으니 사용을 자제해 주세요.</li>
