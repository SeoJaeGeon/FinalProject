...
<body>
	<div class="content">
		...
		<form id="pwdResetForm" action="pwdReset.do" method="POST"
			onsubmit="return pwdReset();" enctype="multipart/form-data">
			<table align="center">
				<tr>
				...
				<tr>
					...
					<td class="right"><span class="userId">${ userId }</span> <input
						type="hidden" id="userId" name="userId" value="${ userId }">
					</td>
				</tr>
				<tr>
					<td class="left">새 비밀번호</td>
					<td class="right"><input type="password" name="userPwd"
						class="newPwd" id="newPwd" placeholder="영문, 숫자, 특수기호 중 2가지 이상 조합"></td>
				</tr>
				<tr>
					<td class="left">새 비밀번호 확인</td>
					<td class="right"><input type="password" name="userPwd2"
						class="newPwd2" id="newPwd2"
						placeholder="영문, 숫자, 특수기호 중 2가지 이상 조합"></td>
				</tr>
				<tr>
			...
			<button type="submit" id="pwdBtn" class="pwdBtn">확인</button>
		</form>
	</div>
	<script>
        function pwdReset() {
