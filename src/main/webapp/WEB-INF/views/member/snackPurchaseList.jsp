...
<head>
	...
	<link href="${ contextPath }/resources/css/member/snackPurchaseList.css" rel="stylesheet" type="text/css">
						...
						<table class="contentTable">
							<tr class="topLine">
								<td>
									<table class="table">
										<tr>
											<th scope="col" class="th no">주문 NO.
								</td>
								<th scope="col" class="th proName">상품명</td>
								<th scope="col" class="th purchaseDate">구매일</td>
								<th scope="col" class="th expDate">유효기간</th>
							</tr>
