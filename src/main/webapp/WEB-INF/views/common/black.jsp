        ...
        <div class="modal-content">
            ...
            <div>
                <a href="javascript:back();">
                    <img class="logoImg" src="${ contextPath }/resources/images/logo_navy.png">
                </a>
            </div>
            <div class="content">
                <form id="joinFrm" action="login.do" method="POST" onsubmit="return login();" enctype="multipart/form-data">
                    <table align="center">
                        <tr>
                            ...
                            <td class="right"><input type="text" id="userId" class="userId" name="userId" placeholder=" 아이디"></td>
                        </tr>
                        <tr>
                            <td class="left">비밀번호</td>
                            <td class="right"><input type="password" id="userPwd" class="userPwd" name="userPwd"
                                    placeholder=" 비밀번호"></td>
                        </tr>
                        <tr>
